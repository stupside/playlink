...
import useVideoVolume from "../Contexts/hooks/useVideoVolume";
  ...
  return (
    <div className="flex items-center w-1/3">
      ...
      <div className="relative w-full flex items-center ml-5 cursor-pointer">
        <div
          className="absolute w-full flex items-center rounded-full"
          onMouseDown={() => {
            setHolding(true);
          }}
          onMouseUp={() => {
        ...
        >
          <div
            className={`absolute w-full h-2 ${colors.default} opacity-30 rounded-full`}
          ></div>
          ...
          <div className="absolute w-full flex items-center rounded-full">
            ...
            <button
              title="volume"
              className={`w-4 h-4 rounded-full ${colors.current} -ml-2`}
            ></button>
          </div>
        </div>
      </div>
